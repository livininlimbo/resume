...
const Footer = () => {
    return (
        <footer className="flex flex-col h-30 pt-2 rounded-full border-t border-gray-200 dark:border-gray-700 bg-white text-gray-700 dark:bg-black p-2 overflow-hidden justify-end items-end mx-0">
            <motion.div initial={{ opacity: 0.4, scale: 0.8}} whileInView={{ opacity: 1, scale: 1}} viewport={{ once: true}} className="flex flex-col w-full max-w-screen-xl mt-2 mx-10 p-4  md:py-4 overflow-hidden lg:mx-10 md:mx-10 sm:mx-0 xs:m-1 xs:mr-4"> 
